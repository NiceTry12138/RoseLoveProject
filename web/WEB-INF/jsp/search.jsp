...
<nav class="navbar navbar-default navbar-static-top">
    <div class="container" style="font-size: 30px;">
        <a href="javascript:changePage('index')" target="_blank">首页</a>
        <a href="javascript:changePage('search')" target="_blank">搜索</a>
        <a target="_blank">交友论坛</a>
        <a target="_blank">活动</a>
        <a href="javascript:changePage('personnal')" target="_blank">个人中心</a>
    </div>
</nav>

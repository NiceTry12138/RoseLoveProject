...
<div style="padding-bottom: 5%; background-color: rgb(250,118,131); ">
    ...
    <div style="text-align: right;">
        ...
        <button type="button" class="btn MyButton" style="margin-right: 30px;" onclick = "window.location.href = '${pageContext.request.contextPath}/login.jsp'">登录</button>
    </div>
...
<div class="container">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="example-navbar-collapse">
                    <ul class="nav navbar-nav col-md-10" style="text-align: center">
                        <li class="col-md-2 col-md-offset-1"><a class="head-font" href="index.jsp">首页</a></li>
                        <li class="col-md-2"><a class="head-font" href="search.jsp">搜索</a></li>
                        <li class="col-md-2"><a class="head-font" href="communication.html">交友论坛</a></li>
                        <li class="active col-md-2"><a class="head-font" href="activity.jsp">活动</a></li>
                        <li class="col-md-2"><a class="head-font" href="personnal.jsp">个人中心</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1" style="background-color: rgba(255,255,255,1); line-height: 46px; ">
            ...
            <div class="col-md-4 col-md-offset-2" style="text-align: right"><a href="${pageContext.request.contextPath}/addActivity.jsp">发布活动</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/Myactivity.html">我的活动</a></div>
        </div>
    </div>
    <script>
        countActivity({});
